...
namespace PerPlayerLoot
{
    ...
    public class FakeChestDatabase
    {
        ...
        public FakeChestDatabase(string connectionString, bool useMySQL = false)
        {
        ...
        public void LoadFakeChests()
        {
            ...
            if (_useMySQL)
            {
                using (MySqlConnection conn = new MySqlConnection(_connectionString))
                {
                    ...
                    // load loot chests
                    using (var cmd = new MySqlCommand("SELECT id, playerUuid, x, y, items FROM chests;", conn))
                    {
                    ...
                    using (var cmd = new MySqlCommand("SELECT x, y FROM placed;", conn))
                    {
                        MySqlDataReader reader = cmd.ExecuteReader();
